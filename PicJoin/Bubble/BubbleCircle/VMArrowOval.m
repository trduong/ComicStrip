...
- (void)drawRect:(CGRect)rect {
    switch (self.type) {
        case 1:
            [BubbleOval drawArrowWithFrame:self.bounds boder:0 bgColor:self.backgroundColor];
            break;
        case 2:
        ...
        case 4:
            ...
            break;
        case 5:
            [AllBubble drawArrowBubbleStarWithFrame:self.bounds boder:0 bgColor:self.backgroundColor];
            break;
        case 6:
            [AllBubble drawArrowOvalDashWithFrame:self.bounds bgColor:self.backgroundColor];
            break;
        case 7:
            [AllBubble drawArrowPointerWithFrame:self.bounds boder:0 bgColor:self.backgroundColor];
            break;
        case 8:
