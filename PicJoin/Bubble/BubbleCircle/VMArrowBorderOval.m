...
@implementation VMArrowBorderOval
...
- (void)drawRect:(CGRect)rect {
    switch (self.type) {
        case 1:
            [BubbleOval drawArrowBorderWithFrame:self.bounds boder:4 bgColor:self.backgroundColor bdColor:self.boderColor];
            break;
        case 2:
        ...
        case 4:
            ...
            break;
        case 5:
            [AllBubble drawArrowBoderBubbleStarWithFrame:self.bounds boder:4 bgColor:self.backgroundColor bdColor:self.boderColor];
            break;
        case 6:
            [AllBubble drawArrowBoderOvalDashWithFrame:self.bounds boder:4 bgColor:self.backgroundColor bdColor:self.boderColor];
            break;
        case 7:
            [AllBubble drawArrowBoderPointerWithFrame:self.bounds boder:4 bgColor:self.backgroundColor bdColor:self.boderColor];
            break;
        case 8:
            break;
        default:
