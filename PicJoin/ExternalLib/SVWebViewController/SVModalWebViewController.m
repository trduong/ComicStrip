...
- (id)initWithURL:(NSURL *)URL {
    ...
    if (self = [super initWithRootViewController:self.webViewController]) {
        ...
        self.webViewController.navigationItem.leftBarButtonItem.tintColor = [UIColor blackColor];
    }
    return self;
}
...
//    [self.navigationBar setBackgroundImage:NULL forBarMetrics:UIBarMetricsDefault];
}
